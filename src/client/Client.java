...
public class Client implements Callable<Integer> {
    ...
    protected static double[] weights = {4.33390619023233,5.298118218820553,8.58779261794399,2.9439039170482495,6.569481687056326,2.9158311744799525,7.580389872569201,8.175775867806239,8.630962464757433,4.245366951962528}; //3 PER I BIANCHI 21
    //protected static double[] weights ={4.584377743927578,7.079483277270357,3.192965225478226,1.480581092631288,8.960026173394068,1.857562360010182,7.08287614389612,14.634985264738383,1.8401194488825734,4.030292506538813}; //2 PER I BIANCHI
    //protected static double[] weights = {7.609734594562109,8.123747815463352,3.431904481529693,5.407894927330962,2.5234346798602947,1.9179947349067827,3.9697450276791937,7.975120185285592,3.2507008402266866,8.187762207546722};//2 PER I BIANCHI
    //protected static double[] weights = {5.414040062028535,0.06408644334610303,0.06859883511475595,8.102063972782604,1.7644592171299067,0.6864202948751519,6.680715182359252,1.9847345796833815,4.232931236749085,2.598971847125399}; //1 PER I BIANCHI
    ...
    //protected static double[] weights = {9.389776654558158,0.10574026884115462,2.0755798976385176,4.403229726133028,3.571539782776829,0.12944669674123999,7.044605336888342,0.5114350076553287,3.7401740227408142,3.352876193998066}; //SONO UNA BOMBA PER I NERI
    ...
    @CommandLine.Option(names = {"-t", "--timer"}, required = false, description = "move max time")
    protected static int timer = 60;
